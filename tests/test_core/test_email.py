...
from app.parsers import EmailOrderParser
...
class TestEmailParser:
    ...
    def test_parse_order(self, root):
        order = EmailOrderParser().parse(Path("data/email.eml"))
    ...
    def test_extract_order_id(self):
        ...
        order_id = EmailOrderParser()._extract_order_id(page)
    ...
    def test_extract_order_date(self):
        ...
        date = EmailOrderParser()._extract_order_date(page)
    ...
    def test_extract_description(self):
        ...
        description = EmailOrderParser()._extract_description(page)
    ...
    def test_extract_wirehouse_id(self):
        ...
        wirehouse_id = EmailOrderParser()._extract_warehouse_id(page)
